...
export function renderNav(): HTMLElement {
    ...
    nav.innerHTML = `
        <div class="flex justify-center py-4 md:py-0 md:justify-between items-center ">
            <div>
                <h1 class="hidden md:inline-flex text-white text-xl  font-bold"><a href="/" data-link>Transcendence</a></h1>
            </div>
            <div class="flex flex-col md:flex-row text-3xl md:text-base  items-center">
                ...
                <button id="logoutBtnAll" class=" bg-gray-500 hover:bg-red-800 hover:ring-2 ring-gray-700 ring-inset text-white px-3 py-1 rounded cursor-pointer mt-6 md:mt-0">Log Out All Sessions</button>
            </div>
        </div>
    `;
