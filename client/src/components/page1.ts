...
export function renderPage1(): HTMLElement {
    ...
    container.className = 'bg-black/50 p-6 rounded-lg';
    
    container.innerHTML = `
        <div id="mainContainer" class="flex flex-row justify-center md:justify-start bg-white-100/40 text-gray-800 p-2">
