...
//     {
//         path: '/page2',
//         component: () => import('./components/page2.js').then(m => ({ default: m.renderPage2 }))
//     },
//     {
//         path: '/friends',
...
//                     // Aktualizace URL bez plného přesměrování - použití hash
...
//                 e.preventDefault();
//                 console.log("path 1: ", target.getAttribute('href'));
