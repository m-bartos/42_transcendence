            ...
            <form id="settingsForm" class="space-y-8 w-full">
                    ...
                    <div class="flex items-center justify-around space-x-4">
                        <div class="w-24 h-24 border border-gray-400 rounded-full bg-gray-200/80 flex items-center justify-center overflow-hidden">
                            <img id="avatarPreview" class="w-full h-full object-cover" 
                                 src="${user && user.avatar ? user.avatar : getAvatar('')}"
                                 alt="profile picture">
                        </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-1 group relative">
                        <div class="absolute border-1 border-red-800 -top-15 left-70 bg-gray-100 text-base rounded-md p-2 opacity-0 transition-opacity duration-200 group-hover:opacity-100 max-w-[300px] z-100">
