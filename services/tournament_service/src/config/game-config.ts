...
export const PADDLE_MOVE_STEP = 1.1;
export const PADDLE_WIDTH = 1; // X % of field width
export const PADDLE_HEIGHT = 20;  // X % of field height
...
export const BALL_MAX_SPEED = 3; // till 1.5-2 playable
